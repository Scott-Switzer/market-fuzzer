...
for i, case in enumerate(cases, 1):
    ...
    print('  forward_test overall_loss:', data['forward_test']['overall_loss_rate_pct'], 'worlds:', data['forward_test']['total_worlds'])
    ...
    print('  segment labels:', sorted((data.get('failure_analysis') or {}).get('segmentation_insights', {}).keys())[:2])
