...
4. **World generation is primary; execution testing is the proof.** The UI leads with issuer, macro, event, agent, and book construction, then demonstrates value through a measurable parent-order experiment.
